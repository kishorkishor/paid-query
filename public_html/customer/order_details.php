  ...
  <div class="card" id="cartonsCard">
    ...
    <?php else: ?>
      <form id="cartonForm" method="post" action="/customer/shipment_payment.php?order_id=<?= (int)$orderId ?>&pay=bd_final">
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td>
                  <?php if ($paidFlag): ?>
                    <span class="pill" style="background:#ecfdf5;border-color:#bbf7d0;color:#065f46">Paid</span>
                  ...
                  <?php elseif ($atBDUnpaidFlag): ?>
                    <span class="pill" style="background:#fff7ed;border-color:#fed7aa;color:#92400e">At BD (unpaid)</span>
                  <?php else: ?>
                    <span class="pill" style="background:#eef2ff;border-color:#e5e7ff;color:#1e3a8a">In transit</span>
                  <?php endif; ?>
                </td>
        ...
        <div class="selbar">
          <div><strong>Selected (to pay):</strong> <span class="mono" id="selTotal">$0.00</span></div>
          <div class="actions">
            <button type="submit" class="btn ok" id="payBankBtn" <?= $selectablePay? '' :'disabled' ?>>Pay Selected (Bank)</button>
            <button type="button" class="btn" id="payWalletSelectedBtn" <?= $selectablePay? '' :'disabled' ?>>Pay Selected (Wallet)</button>
